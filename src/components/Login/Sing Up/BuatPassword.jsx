...
import { postUserPassword,getUser } from '../../services/authServices'
            ...
            <Content>
              <div style={{padding:"30px",background: "#F0F8FF"}}>
                <Card style={{width:"700px",margin:"auto",height:"500px",padding:"30px",boxShadow:" 1px 1px 3px grey"}}>
                  ...
                  <Button style={{margin:"15px",width:"580px",height:'50px'}} type="primary"onClick={()=>{postUserPassword(dataUser,setDataUser,setMessage,setIsEditing)
